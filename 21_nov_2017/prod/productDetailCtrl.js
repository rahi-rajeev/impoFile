	...
	*****/
	function productDetailHandler($scope,salesfactoryData,$filter,$window,$timeout,$http,$location,$anchorScroll,$rootScope,$sce){
		...
		for(i=0;i<dataLength;i++) {
			/*if(!_.isUndefined(productData.oneProductInfo.prdType) && productData.oneProductInfo.prdType==="bundle")
			  rvCtrl.totalQtyVal[i] = 0;
			else*/
			  rvCtrl.totalQtyVal[i] =1;
		}
		//console.log(Object.keys(productData.productInfo).length)
