                    ...
                    <div class="form-row">
                       @if(Auth::check())  
                        ...
                        <div class="price-wrap">
                            ...
                            <button type="button" ng-if="parseInt(prdDetails.totQty) === 0 || prdDetails.totQty == '' " class="btn disable-button">Sold Out</button>
                        </div>
                    </div>             
                    <div class="row">
                       <div class="pdetail-row select-row  select-<%prdDetails.mainProductId%>-<%$index%>" data-ng-if="rvCtrl.attrRes[prdDetails.mainProductId].length > 0">
                                       ...
                                       <div class="pdetail-row color-choose"> 
                                            <ul id="colorVariant">
                                                <li ng-repeat="attrname in rvCtrl.attrValRes[prdDetails.mainProductId][atr.attribute_id] track by attrname.valId" uib-popover-html="attrname.tooltip" popover-trigger="'mouseenter'">
                                                    ...
                                                    <input type="radio" name="color-<%atr.attribute_id%>-<%$parent.$index%>" ng-model="rvCtrl.selAttrVal[prdDetails.mainProductId][$parent.$index].valId" ng-change="rvCtrl.changeContent($parent.$index,atr.attributedesc.attr_id,prdDetails.mainProductId,prdDetails.id,$parent.$parent.$parent.$index, atr.attribute_id)" value="<%attrname.valId%>"  class="multiSelectRadioBtn" ng-disabled="attrname.disable_attr" ng-class="{'prd-out-of-stock'  : attrname.disable_attr}">
                        ...
                        <div class="col-sm-6"> 
                            ...
                            <span class="spiner" ng-class="{'disable-button' : prdDetails.totQty == 0 || prdDetails.totQty == ''}">
                                ...
                                <input type="text" id="quantity" name="quantity" class="spinNum input-text qty" ng-model="rvCtrl.totalQtyVal[$index]" ng-blur="rvCtrl.incDcrQuntity($event, prdDetails.totQty, 'tqchange',prdDetails.id,$index)" number-only> 
