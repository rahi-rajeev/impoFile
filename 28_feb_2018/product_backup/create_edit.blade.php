                                      ...
                                      <div class="col-sm-3">
                                          ...
                                          <div class="input-group date-wrap">
                                             {{-- <input type="text" class="date-select" data-ng-model="product.sp_fromdate"> --}}
                                              <div class="input-group">
                                                  <input name="sp_fromdate" class="form-control" datetimepicker ng-model="product.sp_fromdate"  options="prdData.dateFromOption" on-change="_updateDatePicker(product.sp_fromdate,product.sp_todate,'dateFromOption','dateToOption')" />
                                                  <span class="input-group-addon">
                                                      <span class="glyphicon glyphicon-calendar"></span>
                                                  </span>
                                              </div>
                                      ...
                                      <div class="col-sm-3">
                                          ...
                                          <div class="input-group  date-wrap">
                                             {{-- <input type="text" class="date-select" data-ng-model="product.sp_todate"> --}}
                                              <div class="input-group">
                                                  <input name="sp_todate" class="form-control" datetimepicker ng-model="product.sp_todate" options="prdData.dateToOption" on-change="_updateDatePicker(product.sp_fromdate,product.sp_todate,'dateFromOption','dateToOption')" />
                                                  <span class="input-group-addon">
                                                      <span class="glyphicon glyphicon-calendar"></span>
                                                  </span>
                                              </div>
