 ...
 <div class="content">
        ...
        <div class="content-wrap clearfix">
            ...
            <div class="col-sm-7">
               ...
               {!! Form::open(['url' => action('Admin\Attribute\AttributeController@updateset', $attributeset->id), 'id'=>'AttributeSetForm', 'class'=>'form-horizontal', 'files'=>true]) !!}
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="file-wrapper">
                              ...
                              @if(!empty($attributeset->remind_icon))              
                               ...
                               <img src="{{ Config::get('constants.remind_url') . $attributeset->remind_icon }}" width="38" height="38" class="switherimage">;
                                ...
                                <div class="blank-drag" id="dragto">
                                 ...
                                 @else 
                                   <table>
                                    <tbody class="attr-row-wrap" id="attr-row-wrap">
                                    @php($i = 1)
                                     @foreach($alreadysetAttribute as $result) 
                                      <tr class="attr-row" itemid="itm-{{ $result->id }}">
                                        <td>{{$i++}}
                                            <input type="hidden" name="attributes_id[]" value="{{ $result->id }}">
