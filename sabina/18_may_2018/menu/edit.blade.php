    ...
    <div class="content">
        ...
        <div class="content-wrap clearfix">
            <div class="content-left">
                <div class="tablist">                    
                    <ul class="">
                        <li class="active" data-toggle="tab" data-target="#attr-general"><a >@lang('attribute.general')</a></li>
                        <li class="manage-value" data-toggle="tab" data-target="#attr-manage" @if($attribute->front_input == 'select' || $attribute->front_input == 'multiselect') style="display:block;" @else style="display:none;" @endif >
                           <a >@lang('attribute.manage_value')</a>
                        </li>
                    </ul>
                </div>
            </div>
