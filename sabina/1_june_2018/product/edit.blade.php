...
@section('title')
  @lang('product.edit_product') - {{getSiteName()}}
@stop
          ...
          <div class="content-wrap clearfix">
                  ...
                  <div class="tablist">
                      ...
                      <ul class="">
                        ...
                        <!--   <li ng-if="prdData.parent_id==0" ng-class="{'active' : $root.prd_tab.enable_requirement_tab}" ng-click="liActiveHandler($event,'enable_requirement_tab')" data-toggle="tab" data-target="#product_requirement">
                          ...
                          <li ng-if="prdData.parent_id>0" ng-class="{'active' : $root.prd_tab.enable_variants_spec_tab}" data-toggle="tab" data-target="#variant_specification" ng-click="liActiveHandler($event,'enable_variants_spec_tab')"> 
                            @lang('product.variants_spec')
                          </li>
              ...
              <div class="content-right container"> 
                  <div class="tab-content">
                      ...
                      <div id="variant_specification" class="tab-pane" ng-class="{'in active' : $root.prd_tab.enable_variants_spec_tab}">
                          @include('admin.includes.variant_specification')                             
                      </div>
