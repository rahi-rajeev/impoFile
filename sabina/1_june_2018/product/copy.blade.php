...
@section('title')
  @lang('product.copy_product') - {{getSiteName()}}
@stop
...
<script type="text/javascript">
  ...
  var current_blade_type = "copy_product";
    ...
    <div class="content">
      ...
      @endif       
          ...
          <div class="header-title">
              <h1 class="title">@lang('product.copy_product')</h1>
              <div class="pull-right btn-groups">
                  {{-- <a href="{{action('Admin\Product\ProductController@edit',['id'=>$product_detail['id']])}}"  class="btn-default">@lang('common.copy')</a> --}}
                  ...
                  <button name="submit_type" value="save_and_continue" class="secondary" ng-disabled="prdData.loading.disableBtn" ng-click="copyProduct($event, productform, 'save_and_continue')">@lang('common.save_and_continue')</button>
                  <button name="submit_type" value="save" class="btn" ng-disabled="prdData.loading.disableBtn" ng-click="copyProduct($event, productform, 'save')">
              ...
              <div class="content-right container"> 
                  <div class="tab-content">
                      <div id="product_detail" class="tab-pane fade" ng-class="{'in active' : $root.prd_tab.enable_product_tab}">
                          ...
                          <div class="form-row">
                              <label>{{-- sku --}} @lang('product.sku') <i class="red"> *</i></label>
                                  <input type="text" value="product.sku" name="sku" ng-model="product.sku" ng-blur="checkcopysku(product.sku)" /> 
                          ...
                          <div class="form-row row">
                              <span class="col-sm-5">
                                  ...
                                  <tags-input placeholder="@lang('product.product_tag')" ng-model="product.prdtags" name="tagss" display-property="tag_title" required>
                    ...
                    <!-- <div class="form-row row">
                          ...
                          <div class="form-row">
                          <h2 class="title-prod">
                              <i class="count">5</i> {{-- Shop Categories --}} @lang('product.shop_categories') <i class="red">*</i>                              
                            </h2>
                             <h3>{{-- Shop Categories --}} @lang('product.shop_categories') </h3>
                             <div ng-show="prdData.cateTree.length<1">
                             <a href="{{action('Admin\Category\CategoryController@create')}}" class="btn-grey">+ {{-- Create new category --}}@lang('product.create_new_cat')</a></div>
