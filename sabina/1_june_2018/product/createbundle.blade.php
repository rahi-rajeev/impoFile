...
@section('title')
  @lang('product.bundle_product') - {{getSiteName()}}
@stop
...
@section('content')
 ...
 <script type="text/javascript">
    ...
    var simple_config_img_path ="{{ Config::get('constants.product_thumb105145_url') }}";
            ...
            @endif       
                ...
                <div class="header-title">
                    ...
                    <div class="pull-right btn-groups">
                        ...
                        <button  name="submit_type" value="save" class="btn" ng-disabled="prdData.loading.disableBtn" ng-click="saveProduct($event, productform, 'save')">@lang('common.save')</button>
                    </div>
                </div>
                ...
                <div class="content-wrap clearfix">
                    <div class="content-left">
                        <div class="tablist">
                            ...
                            <ul class="">
                                <li class="" id="product" ng-class="{'active' : $root.prd_tab.enable_product_tab}" ng-click="liActiveHandler($event,'enable_product_tab')" data-toggle="tab" data-target="#product_detail">
                                ...
                                <li ng-class="{'active' : $root.prd_tab.enable_bundel_tab}" ng-click="liActiveHandler($event,'enable_bundel_tab')" data-toggle="tab" data-target="#product_bundle">
                                    {{-- <a data-toggle="tab" href="#product_bundle"> --}}
                                     @lang('product.bundle_product')
                                    {{-- </a> --}}
                                </li>
                               {{--  <li ng-class="{'active' : $root.prd_tab.enable_variants_tab}" ng-click="liActiveHandler($event,'enable_variants_tab')" data-toggle="tab" data-target="#product_variants">
                                ...
                                <li id="related_product" ng-class="{'active' : $root.prd_tab.enable_related_tab}" ng-click="liActiveHandler($event,'enable_related_tab')" data-toggle="tab" data-target="#product_related">
                                ...
                                <!--<li id="private_zone" ng-class="{'active':$root.prd_tab.enable_private_zone_tab}" ng-click="liActiveHandler($event,'enable_private_zone_tab')" data-toggle="tab" data-target="#product_private_zone">
                    ...
                    <div class="content-right container"> 
                        <div class="tab-content">
                            ...
                            <div class="form-row">                                
                                @include('admin.includes.product_create_image_upload')
                            ...
                            <!--video section end-->
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="checkbox" ng-model="product.autosku" value="true"> <span class="chk-label">@lang('product.autosku')</span></label>
                                        ...
                                        <div class="form-row row">
                                            <div class="col-sm-3">
                                                ...
                                                <div class="check-group mt-5 mb-5">
                                                  <label class="check-wrap"> 
                                                    <input type="checkbox" name="exp_date" class="checkbox" id="exp_date" ng-model="product.exp_date"> 
                                                ...
                                                <div class="expdate" ng-if="!product.exp_date">
