...
<div class="content">
    ...
    <div class="content-wrap clearfix">
        ...
        <div class="col-sm-7">
            <h2 class="attr-title"><strong>@lang('attribute.attribute_set')</strong></h2> {!! Form::open(['url' => action('Admin\Attribute\AttributeController@updateset', $attributeset->id), 'id'=>'AttributeSetForm', 'class'=>'form-horizontal', 'files'=>true]) !!}

            <div class="row">
                <div class="form-row">

                    <div class="col-sm-4 {{ $errors->has('attribute_code') ? 'error' : '' }}" ">  <label>@lang('attribute.set_name')<i class="red ">*</i> </label>
                          {!! Form::text('name', old('name', $attributeset->name), ['placeholder'=>'', 'disabled'=>true]) !!}
                          @if ($errors->has('name'))
                       ...
                       <div class="col-sm-4 ">
                         <label>@lang('attribute.base_on')</label>
                           {!! Form::select('base_on_id', $attributesets,  $attributeset->base_on_id, ['disabled'=>true])  !!}
                       </div>
                    ...
                    <div class="form-row ">
                        <div class="col-sm-8 ">
                          <label>@lang('attribute.description')</label>
                           {!! Form::textarea('description', old('description', $attributeset->description), ['placeholder'=>'']) !!}
                         </div>
                    </div>
                    <div class="form-row color-group ">
                        <div class="col-sm-2 ">
                           ...
                           {!! Form::text('label_flag', old('label_flag', $attributeset->label_flag), ['placeholder'=>Lang::get('attribute.label_flag')]) !!}
                        ...
                        <div class="col-sm-2 ">
                            ...
                            <span id="font-color " class="input-group colorpicker-component ">
                               {!! Form::text('font_color', old('font_color', $attributeset->font_color), ['placeholder'=>'', 'value'=>'#ff004a']) !!}
                        ...
                        <div class="col-sm-2 ">
                            ...
                            <span id="bg-color " class="input-group colorpicker-component "> 
                                 {!! Form::text('flag_bg_color', old('flag_bg_color', $attributeset->flag_bg_color), ['placeholder'=>'', 'value'=>'#000']) !!}
                        ...
                        <div class="col-sm-2 ">
                            ...
                            <div class="file-wrapper ">
                              ...
                              @if(!empty($attributeset->remind_icon))              

                               <img src="{{ Config::get( 'constants.remind_url') . $attributeset->remind_icon }}" width="38" height="38" class="switherimage">; @else

                        <img src="images/browse-btn3.png" width="38" height="38"> @endif
                        </span>
                        {!! Form::file('remind_icon', ['class'=>'form-control']) !!} @if ($errors->has('remind_icon'))
