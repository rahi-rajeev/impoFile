  ...
  @endif       
      ...
      <div class="header-title">
          ...
          <div class="pull-right btn-groups">
              <a href="{{ action('Admin\Product\ProductController@index') }}" class="btn-default">@lang('common.back')</a>
                                           ...
                                           <ul class="files">
                                             <li ng-repeat="file in prevImage">
                                                <div class="col-sm-2">
                                                 ...
                                                 <div class="col-sm-6">
                                                     <p> 
                                                      <input name="default_image" type="radio" value="<%$index%>" ng-model="product.defaultImage" ng-checked="<%file.isDefault==1%>"> 
                                              ...
                                              <li ng-repeat="item in product.file_interface.getFiles(product.file_interface.FILE_TYPES.VALID)">
                                                 ...
                                                 <div class="col-sm-6">
                                                    ...
                                                    <p> 
                                                    {{-- <%product.defaultImage === $index%> --}}
                                                      <input name="default_image" type="radio" value="<%$index%>" ng-model="product.defaultImage" ng-checked=""> 
                                                      @lang('product.set_as_display_img')
                                                     </p>
                                                 </div>
                                                 <div class="col-sm-2">
