...
<script type="text/javascript">
 ...
 /***end related oroduct***********/
  ...
  var btnloaderpath ="{{Config::get('constants.loader_url').'loading_small.gif'}}";
  //add remove wishlist url and related product
  ...
  var related_prd_url =  "{{ action('ProductDetailController@getRelatedProducts') }}";
</script>
...
<!-- Content section start -->
    <div class="productDisplay ng-cloak"  data-ng-app="productDetailApp" data-ng-controller="productDetailCtrl as rvCtrl" ng-cloak>
                ...
                <div class="product-info-row" ng-repeat ="prdDetails in rvCtrl.productInfo track by $index">
                    <div class="form-row">
                       @if(Auth::check())  
                        ...
                        <div class="soldout-prd">
                            <span ng-if="prdDetails.sold_out" class="btn disable-button">Sold Out</span>
                        </div>
                    </div>             
                    <div class="row">
                       <div class="pdetail-row select-row  select-<%prdDetails.mainProductId%>-<%$index%>" data-ng-if="rvCtrl.attrRes[prdDetails.mainProductId].length > 0" style="overflow: hidden;">
                            <h3 class="col-sm-12">@lang('checkout.please_choose_before_add_to_shopping_bag')</h3>
                                <div class="size col-sm-6" data-ng-repeat="atr in rvCtrl.attrRes[prdDetails.mainProductId] track by $index">
                                    <label class=""><%atr.attributedesc.name%> <span class="star-top">*</span></label>
                                       <span class="custom-select" data-ng-if="atr.attribute.attribute_type_value == 'plain_text' && atr.attribute.display_style == 'dropdown'">
                                          <select class="select attrVal" id="attributeValueId[]" data-ng-model="rvCtrl.selAttrVal[prdDetails.mainProductId][$index]" data-ng-change="rvCtrl.changeContent($index,atr.attributedesc.attr_id,prdDetails.mainProductId,prdDetails.id,$parent.$parent.$index, atr.attribute_id)" ng-options="attrname.value for attrname in rvCtrl.attrValRes[prdDetails.mainProductId][atr.attribute_id] track by attrname.valId" ng-options-class="attrname.value" required>
                                          <option value="" disabled="disabled">@lang('common.select')</option>
                                        </select>
                                      </span>
                                      <span class="custom-select" data-ng-if="atr.attribute.attribute_type_value == 'plain_text' && atr.attribute.display_style == 'box'">
                                        <ul class="color-choose">
                                          <li ng-repeat="attrname in rvCtrl.attrValRes[prdDetails.mainProductId][atr.attribute_id] track by attrname.valId" uib-popover-html="attrname.tooltip" popover-trigger="'mouseenter'">
                                                    <span class="select-color">
                                                    <input type="radio" ng-model="rvCtrl.selAttrVal[prdDetails.mainProductId][$parent.$index].valId" ng-change="rvCtrl.changeContent($parent.$index,atr.attributedesc.attr_id,prdDetails.mainProductId,prdDetails.id,$parent.$parent.$parent.$index, atr.attribute_id)" value="<%attrname.valId%>"  class="multiSelectRadioBtn" ng-disabled="attrname.disable_attr" ng-class="{'prd-out-of-stock'  : attrname.disable_attr}">
                                                        <span class="color-wrapper" ng-style="rvCtrl.selAttrVal[1] && { 'background' : 'red' }">
                                    
                                                            <span class="product-img color-text" data-ng-if="attrname.value !=''">
                                                ...
                                                <li ng-repeat="attrname in rvCtrl.attrValRes[prdDetails.mainProductId][atr.attribute_id] track by attrname.valId" uib-popover-html="attrname.tooltip" popover-trigger="'mouseenter'">
                                                    ...
                                                    <input type="radio" ng-model="rvCtrl.selAttrVal[prdDetails.mainProductId][$parent.$index].valId" ng-change="rvCtrl.changeContent($parent.$index,atr.attributedesc.attr_id,prdDetails.mainProductId,prdDetails.id,$parent.$parent.$parent.$index, atr.attribute_id)" value="<%attrname.valId%>"  class="multiSelectRadioBtn" ng-disabled="attrname.disable_attr" ng-class="{'prd-out-of-stock'  : attrname.disable_attr}">
                                                        <span class="color-wrapper" ng-style="rvCtrl.selAttrVal[1] && { 'background' : 'red' }">
                                                            ...
                                                            <span class="product-img color-text" data-ng-if="attrname.color_image =='' && attrname.color_code =='' && attrname.value !=''">
                                                             <div class="taxt-value"><%attrname.value%></div>
                                                            </span>
                                                          <!-- <span class="color-name"><%attrname.value%> </span> -->
                                                        </span>
                                                    </span>
                        ...
                        <div class="pdetail-row pdetail-choseinfo" data-ng-if="rvCtrl.optionInfo[prdDetails.mainProductId].length > 0" style="overflow: hidden;>
                            <div class="" ng-repeat="optionRes in rvCtrl.optionInfo[prdDetails.mainProductId] track by $index">
                                <div class="col-sm-12" data-ng-if="optionRes.option_attr_detail.front_input=='text'">
                                ...
                                <div class="col-sm-12" data-ng-if="optionRes.option_attr_detail.front_input=='textarea'">
                                       <label><%optionRes.option_attr_desc.name%> (<%optionRes.price%> <%(optionRes.price_type==2)? '%' : rvCtrl.curCode %> ) </label>
                                ...
                                <div class="col-sm-12" data-ng-if="optionRes.option_attr_detail.front_input=='browse_file'">
                                ...
                                <div class="col-sm-12" data-ng-if="optionRes.option_attr_detail.front_input=='multiselect'">
                        ...
                        <div class="col-sm-12" ng-if="!prdDetails.sold_out"> 
                            <div class="product-item-wrap product-qty-item-wrap">
                              <label>@lang('product.qty')</label>
                              <span class="spiner">
                                  <span class="decrease icon-minus"  ng-click="rvCtrl.incDcrQuntity($event, prdDetails.totQty, 'down', prdDetails, $index)"></span>
                                  <input type="text" id="quantity" name="quantity" class="spinNum input-text qty" ng-model="prdDetails.qty_model" ng-blur="rvCtrl.incDcrQuntity($event, prdDetails.totQty, 'tqchange', prdDetails, $index)" onkeypress="return isNumberKey(event)"> 
                                  <span class="increase icon-plus" ng-click="rvCtrl.incDcrQuntity($event, prdDetails.totQty, 'up', prdDetails, $index)">  </span>
                              </span> 
                            </div>
                        </div>
                    </div>
        ...
        <div class="recommend-product">
            <h2 class="title" style="display: none">You Might Also Like </h2>
            <ul class="recomend-slider" id="related-product-section"></ul>
        </div>
            ...
            <div class="modal-dialog model-md">
                ...
                <div class="modal-content txt-center">
                    <div class="modal-header">
                      ...
                      <% rvCtrl.oneProductInfo.prd_name %> <span>@lang('checkout.added_successfully').</span></h3>
                    </div>
...
@section('footer_scripts')
    <script type="text/javascript" src="{{ Config('constants.js_url')}}slick.min.js"></script>
