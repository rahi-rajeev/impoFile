                        ...
                        <div class="form-row select-color-row" ng-repeat="item in prdData.specs_create_list track by $index">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" ng-if="item.front_input=='date_picker'">
                                    <a class="dropdown-toggle" id="delvdate" role="button" data-toggle="dropdown" data-target="delvdate" href="javascript:void(0)">
                                        <div class="input-group date">
                                            <input type="text" class="date-select" data-ng-model="product.specmodel[$index].deldate">
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        <datetimepicker data-ng-model="product.specmodel[$index].deldate" <!-- data-on-set-time="onSpecDateTimePickerSet(newDate, oldDate, $index)" -->
