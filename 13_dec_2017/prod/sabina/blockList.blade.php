...
@section('content')
    ...
    <div class="content">
        ...
        <div class="content-wrap">
            ...
            @endif 
            <div class="table ">
                <div class="alert alert-success" id="msgDiv" style="display: none">@lang('common.block_deleted_successfully')</div>
...
<script type="text/javascript">
   ...
   <script type="text/javascript">
    ...
    jQuery('.del-block').click(function(){
