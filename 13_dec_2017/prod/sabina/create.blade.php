                                                ...
                                                <div class="input-group date-wrap">
                                                     {{-- <input type="text" name="expiry_date" class="date-select" data-ng-model="product.expiry_date"> --}}
                                                      <div class="input-group">
                                                          <input class="form-control" datetimepicker ng-model="product.expiry_date" options="prdData.dateOption" />
                                                    ...
                                                    href="javascript:void(0)"> --}}
                                                      <div class="input-group date-wrap">
                                                         {{-- <input type="text" class="date-select" data-ng-model="product.sp_fromdate"> --}}
                                                          <div class="input-group">
                                                              <input class="form-control" datetimepicker ng-model="product.sp_fromdate"  options="prdData.dateOption"/>
                                                              <span class="input-group-addon">
                                                                  <span class="glyphicon glyphicon-calendar"></span>
                                                              </span>
                                                          </div>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="input-group  date-wrap">
                                                         {{-- <input type="text" class="date-select" data-ng-model="product.sp_todate"> --}}
                                                          <div class="input-group">
                                                              <input class="form-control" datetimepicker ng-model="product.sp_todate" options="prdData.dateOption" />
                                                              <span class="input-group-addon">
                                                                  <span class="glyphicon glyphicon-calendar"></span>
                                                              </span>
                                                          </div>
