...
<script type="text/javascript">
	...
	var page = 1;
	var varientInfo =[];
	var bgimage_topic_select ="{{ Config::get('constants.image_url')}}topicbgimage.jpg";
</script>
@stop

@section('content')
@if(isset($topics))
<div id="bgimage_topic_select" style="position: absolute;z-index: 100; width: 100%; height: 100%;left:0;top:0;"></div>
...
@section('footer_scripts')
 ...
 <script type="text/javascript" src="{{Config::get('constants.js_url')}}jquery.backgroundScroll.min.js"></script>
 <script type="text/javascript">
 	@if(isset($topics))
		$(function(){
			$('#bgimage_topic_select').backgroundScroll({
			    pattern: true,
			    click: 'stop',
			    img: [bgimage_topic_select],
			    speed: [1, 0.7, 0.8],
