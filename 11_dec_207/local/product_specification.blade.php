...
<!--if there are no attribute condition-->
<div class="attr-mgt-view" ng-hide="true"><!-- data-ng-if="!prdData.specslist.length"> -->
  <h2 class="title">
  ...
  <div class="row">
      <div class="form-row mt-5"> 
          <div class="col-sm-4">
              <a href="#" class="secondary col-sm-12">Create New Attribute</a>
          </div>                                      
      </div>
      <div class="form-row">
          <div class="col-sm-4">
...
<div class="attr-set-container"> <!-- data-ng-if="prdData.specslist.length>0"> -->
  <div class="col-sm-4 attribute-wrap">
     <h2 class="attr-title"><strong>Attribute</strong></h2>
     <a href="javascript:void(0)" class="secondary">Create New Attribute</a>
     <div class="drag-wrap">
         <div class="form-row">
             ...
             <div class="attr-row-wrap ui-sortable dragdropElement" id="attr-dragElement" dnd-list="prdData.specslist" dnd-drop="dropCallback(index, item, external, type, 'specification-leftside')">
                 <div class="attr-row"  itemid="itm-1" ng-repeat="list in prdData.specslist | filter: {attributedesc: {name: prdData.query}} | startFrom:prdData.currentPage*prdData.pageSize | limitTo:prdData.pageSize" dnd-draggable="list"><!-- prdData.specslist.splice($index, 1); -->
                 <dnd-nodrag>
  ...
  <!--if attribute set is available -->
  <div class="col-sm-8 attribute-set-wrap" data-ng-if="prdData.spesattrset.length>0">
    <h3><strong>Attribute Set</strong></h3>
    <div class="hide">
        <div class="form-row">
            <h3>Base Attribute Set : Default</h3>
        </div>
        <div class="form-row">
            <label>Create New Attribute Set</label>
        </div>
            ...
            <div class="col-sm-10">
                <div class="box ">
                    <div class="form-row"> 
                        ...
                        <div class="select-color-row row">
                            <div class="col-sm-6">
                                <select class="multiple-select" multiple="multiple" style="display: none;">
                                    <option selected="">Red</option>
                                    <option>Pink</option>
                                    <option>Yellow</option>
                                </select><div class="chosen-container chosen-container-multi" style="width: 0px;" title=""><ul class="chosen-choices"><li class="search-choice"><span>Red</span><a class="search-choice-close" data-option-array-index="0"></a></li><li class="search-field"><input value="Select Some Options" class="" autocomplete="off" style="width: 25px;" type="text"></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div></div>
                            </div>
                            <div class="col-sm-2 label-option">
                                <label class="check-wrap"><input type="checkbox"> <span class="chk-label">Use variant</span></label>
                            </div>
                            <div class="col-sm-4 check-group label-option-use">
                                 <label class="check-wrap"><input type="checkbox"> <span class="chk-label">Use Specification</span></label>                                                           
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-row">
                   <label>Name <i class="red">*</i></label>
        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="form-row">
                    ...
                    <label>Choose your Attribute Set</label><%product.speschoseattrset%>
    ...
    <div class="form-row row">
        <div class="col-sm-12 radio-group">
            <label class="radio-wrap"><input name="attr-set2" type="radio" ng-model="prdData.spescrtupdate" value="createattrset" ng-change="attrRadiochange('createattrset')"> <span class="radio-label ">Create New Attribute Set</span></label>
            <label class="radio-wrap" ng-if="product.speschoseattrset"><input name="attr-set2" type="radio" ng-model="prdData.spescrtupdate" value="updateattrset" ng-change="attrRadiochange('updateattrset')"> <span class="radio-label ">Update Attribute Set</span></label>
        </div>
    </div>
    <div ng-if="prdData.spescrtupdate==='createattrset'">
        <div class="col-sm-8">
            <div class="form-row">
               <label>Name</label>
                <input placeholder="Attribute Set’s Name" type="text" ng-model="product.sepscreateset.attrname"> 
        ...
        <div class="flag-row col-sm-12">
            ...
            <div class="col-sm-2">
                ...
                <div id="cp2" class="input-group colorpicker-component colorpicker-element"> <input value="#ff0049" class="form-control" type="text" ng-model="product.sepscreateset.fontcolor"> <span class="input-group-addon"><i style="background-color: rgb(255, 0, 73);"></i></span> </div>

            </div>
            <div class="col-sm-3">
                <label>Flag Bg Color</label>
                <div id="cp3" class="input-group colorpicker-component colorpicker-element"> <input value="#020202" class="form-control" type="text" ng-model="product.sepscreateset.flagbgcolor"> <span class="input-group-addon"><i style="background-color: rgb(2, 2, 2);"></i></span> </div>
            </div>
            <div class="col-sm-3">
  ...
  <div class="col-sm-8" data-ng-if="!prdData.spesattrset.length">
      <h2 class="attr-title"><strong>Attribute Set</strong></h2>
      <div class="row">
          <div class="form-row">
              <div class="col-sm-6">
