                                    ...
                                    <div class="special-pricedate" ng-if="product.stbprice=='specialprice'">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="input-group  date-wrap">
                                                  ...
                                                  <div class="input-group">
                                                      <input class="form-control" datetimepicker ng-model="product.sp_todate" options="prdData.dateToOption" on-change="_updateDatePicker(product.sp_fromdate,product.sp_todate,'dateFromOption','dateToOption')"  />
                                                      <span class="input-group-addon">
                                                          <span class="glyphicon glyphicon-calendar"></span>
                                                      </span>
                                                  </div>
