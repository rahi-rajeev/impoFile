...
if (isset($_POST['hidContent'])) {
	session_start(); 
	$_SESSION['content-bootstrap'] = $_POST['hidContent'];
	header("Location: example2-bootstrap.php");
}
?>
...
<div id="contentarea" class="is-container container-fluid">
    <?php
	session_start(); 
	if(empty($_SESSION['content-bootstrap'])==true) {
		...
		echo $_SESSION['content-bootstrap'];
	}
    ?>
</div>
