...
if (isset($_POST['hidContent'])) {
	session_start(); 
	$_SESSION['myheader-bootstrap'] = $_POST['hidHeader'];
	$_SESSION['mycontent-bootstrap'] = $_POST['hidContent'];
...
<div style="background:#eaeaea;float:left;width:100%">
    ...
    <div id="headerarea" class="is-container container-fluid">
		<?php
		session_start(); 
		if(empty($_SESSION['myheader-bootstrap'])==true) {
			...
			echo $_SESSION['myheader-bootstrap'];
		}
		?>
    </div>
...
<div style="background:#f7f7f7;float:left;width:100%">
	...
	<div id="contentarea" class="is-container container-fluid">
		<?php
		session_start(); 
		if(empty($_SESSION['mycontent-bootstrap'])==true) {
			/* Optional initial content */
			echo '<div class="row">
				<div class="col-md-12">
			...
			echo $_SESSION['mycontent-bootstrap'];
		}
		?>
	</div>
