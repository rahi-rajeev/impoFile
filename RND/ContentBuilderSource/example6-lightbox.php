...
if (isset($_POST['hidContent'])) {	
	$_SESSION['content-example-lightbox'] = $_POST['hidContent'];
	header("Location: example6-lightbox.php");
}
?>
...
<div id="contentarea" class="is-container container">
    <?php
	if(empty($_SESSION['content-example-lightbox'])==true) {
		...
		echo $_SESSION['content-example-lightbox'];
	}
    ?>
</div>
